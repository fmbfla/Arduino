...
String substring=""; // a variable to store the substring "PHONE NUMBER"
                      ...
                      /////////////////////////////////////////////////////////////////////////// 
String txtMessage=""; // "&&&&  TEST 1  &&&&&                                    //a variable to store the txtMessage "The inComing Text Message
                      /////////////////////////////////////////////////////////////////////////// 
...
void readSIM900(){
  ...
  if(SIM900.available()) // Check if there is incoming data in the Serial Buffer
  {
    ...
    substring = input_trimmed.substring(7,18); //Because Im using the "+" fromthe beginning of the "Clip" I use the seventh char and the 19th is where the calling fone number is in the string of recieved text
                                                           ...
                                                           //////////////////////////////////////////////////////////////
    txtMessage = input_trimmed.substring(45,61);//  TEST 1          /////////////// Testing going on here! ///////////////
                                                           //////////////////////////////////////////////////////////////
    ...
    if(substring.length()==11){
      ...
      Serial.println();
      if (msgsOut==20){//////////////////////////////////////////////////////////////
       messagesOut();          /////////////// Testing going on here! ///////////////
      } /////////////////////////////////////////////////////////////////////////////
      Message();
      SIM900.flush();
      SIM900.end(); 
...
void messagesOut()
{
  ...
  delay(100);
  //digitalWrite(led, HIGH);
  SIM900.println("Your Constant Harassment of the Arduino has pissed it off!");  
  SIM900.println("You now have to wait until the time is on The HOUR before gaining access to the location of this device");
  delay(100);
  //digitalWrite(led, HIGH);
  SIM900.println((char)26); // End AT command with a ^Z, ASCII code 26
  delay(100);
